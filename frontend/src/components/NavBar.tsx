...
export default function NavBar() {
  ...
  return (
    <nav className="relative sticky top-0 z-50 bg-[#F4F4F4B2] backdrop-blur-[10.85px] flex justify-between items-center w-center px-[30px] pt-[30px] p-[20px] font-dm">
      ...
      <div className="flex items-center gap-8">
        ...
        {isDropdownOpen && (
          <div className="absolute left-0 right-0 top-full bg-[#F4F4F4B2] backdrop-blur-[10.85px] shadow-[0_12px_26px_0_rgba(0,0,0,0.10)]">
              ...
              <div className="flex justify-center gap-[50px]">
                ...
                >
                  <div className="flex flex-col items-start gap-[12px] self-stretch">
                    ...
                    <p className="px-[29px] text-[16px] font-dm font-[400] leading-[24px] text-[#1E1E1E] group-hover:text-white transition-colors">
                      Partner with F3 Global, providing microloans, guidance, and resources designed
                      to support small business owners and entrepreneurs on their path to long-term
                      success.{" "}
                    </p>
                  </div>
                  <div className="flex flex-col justify-center items-center gap-[20px] flex-1 self-stretch">
