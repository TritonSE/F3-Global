...
export const FooterDesktop = function Footer({ onContactClick, onTermsClick }: FooterDesktopProps) {
  ...
  return (
    <footer className="relative left-1/2 w-[100dvw] -translate-x-1/2 bg-[#f4f4f4]">
      <div className="mx-auto flex w-full max-w-[1512px] flex-col justify-center px-[5vw] py-[100px]">
