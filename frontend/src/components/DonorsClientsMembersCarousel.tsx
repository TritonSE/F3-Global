...
import { DonorsClientsMembersCarouselCard } from "./DonorsClientsMembersCarouselCard";

const BUTTON_LABELS = ["Donors", "Clients", "Members"];
...
type DonorsClientsMembersCarouselProps = {
  data: CarouselData[];
} & React.ComponentProps<"div">;

export const DonorsClientsMembersCarousel: React.FC<DonorsClientsMembersCarouselProps> = ({
  data,
  ...props
}) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-none flex-col items-center justify-center gap-[32px] lg:h-[330px] lg:flex-row lg:gap-[50px]">
        ...
        <div>
          {currentCard && (
            <DonorsClientsMembersCarouselCard
