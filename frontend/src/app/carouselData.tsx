export const DonorsClientsMembersCarouselData = [
  {
    ...
    imageSrc: "/imgs/carousel_donors.jpg",
  },
  {
    title: "CLIENTS",
    header: (
    ...
    imageSrc: "/imgs/carousel_clients.jpg",
  },
  {
    title: "MEMBERS",
    header: (
    ...
    imageSrc: "/imgs/carousel_members.jpg",
  },
];
...
export const WaysToGiveCarouselData = [
  {
    ...
    leftButtonText: "DONATE",
    leftButtonLink: "https://www.zeffy.com/en-US/donation-form/donate-to-make-a-difference-7390",
    imageSrc: "/imgs/carousel_one_time.jpg",
  },
  {
    title: "MONTHLY",
    header: (
    ...
    leftButtonLink: "https://www.zeffy.com/en-US/donation-form/donate-to-make-a-difference-7390",
    imageSrc: "/imgs/carousel_monthly.jpg",
  },
  {
    ...
    leftButtonText: "CONTACT US",
    leftButtonLink: "#contact",
    imageSrc: "/imgs/carousel_legacy.jpg",
  },
  {
    title: "CORPORATE",
    header: (
    ...
    leftButtonText: "GET STARTED",
    leftButtonLink: "#contact",
    imageSrc: "/imgs/carousel_corporate.jpg",
  },
];
