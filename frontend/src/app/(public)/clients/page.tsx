  ...
  return (
    <>
      <div className="mx-auto w-full max-w-[1512px] overflow-x-hidden bg-white">
        <div className="flex w-full flex-col-reverse lg:flex-row items-center justify-between self-stretch px-6 sm:px-10 lg:px-[100px] py-12 lg:py-0 gap-10 lg:gap-0">
