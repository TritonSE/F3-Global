export const DonorsClientsMembersCarouselData = [
  {
    ...
    imageSrc: "/imgs/carousel_donors.webp",
  },
  {
    title: "CLIENTS",
    header: (
    ...
    imageSrc: "/imgs/carousel_clients.webp",
  },
  {
    title: "MEMBERS",
    header: (
    ...
    imageSrc: "/imgs/carousel_members.webp",
  },
];
...
export const WaysToGiveCarouselData = [
  {
    ...
    leftButtonText: "DONATE",
    leftButtonLink: "https://www.zeffy.com/en-US/donation-form/donate-to-make-a-difference-7390",
    imageSrc: "/imgs/carousel_one_time.webp",
  },
  {
    title: "MONTHLY",
    header: (
    ...
    leftButtonLink: "https://www.zeffy.com/en-US/donation-form/donate-to-make-a-difference-7390",
    imageSrc: "/imgs/carousel_monthly.webp",
  },
  {
  ...
  },
  {
    ...
    mobileHeader: (
      <span>
        <strong className="text-[#012060]">Multiply</strong> through Employer Matching.
      </span>
    ),
    description:
    ...
    leftButtonText: "GET STARTED",
    leftButtonLink: "#contact",
    imageSrc: "/imgs/carousel_corporate.webp",
  },
];
